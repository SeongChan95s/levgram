	...
	return (
		<>
			...
			<main className="pt-60 min-h-svh flex flex-col">
				{/* 채팅 영역 */}
				<div className="flex-1 overflow-y-auto px-(--inner) py-16 flex flex-col gap-8 pb-120">
					{messages.length === 0 && (
				...
				{/* 입력창 - TabBar 위 고정 */}
				<div
					className="fixed bottom-60 inset-x-0 mx-auto flex items-center gap-8 px-(--inner) py-8 bg-white border-t border-gray-100"
					...
					<button
						...
						className="shrink-0 px-16 py-8 bg-[#5A0FC8] text-white text-label-2 rounded-full disabled:opacity-40 transition-opacity">
						전송
					</button>
				</div>
			</main>
